...
var algos = module.exports = global.algos = {
        ...
        hash: function(coinConfig){
           ...
           // var rValue = coinConfig.rValue || 1;
            ...
            return function (data) {
                ...
                return multiHashing.scrypt(data);
            }
        }
    },
    'scrypt-og': {
    ...
    x11: {
        hash: function(){
            return function(){
                return multiHashing.X11(arguments[0]);
            }
        }
    },
    'lyra2re2': {

        multiplier: Math.pow(2, 25),
        hash: function () {
            return function () {
                return multiHashing.lyra2re2(arguments[0]);
            }
        }
    },
    'neoscrypt': {
        ...
        hash: function () {
            return function () {
                return multiHashing.neoscrypt(arguments[0]);
            }
        }
    },
    x13: {
    ...
    myrgroestl: {
        ...
        hash: function(){            
            ...
            return function () {
                return multiHashing.myrgroestl(arguments[0]);
            }
